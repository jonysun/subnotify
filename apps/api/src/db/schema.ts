...
export const subscriptions = sqliteTable(
  "subscriptions",
  {
    ...
    currentCycle: text("current_cycle", { enum: ["weekly", "monthly", "quarterly", "yearly", "custom"] }).notNull(),
...
export const subscriptionVersions = sqliteTable(
  "subscription_versions",
  {
    ...
    siteUrl: text("site_url").notNull().default(""),
    paymentMethod: text("payment_method").notNull().default(""),
    billingCycle: text("billing_cycle", { enum: ["weekly", "monthly", "quarterly", "yearly", "custom"] }).notNull(),
...
export const payments = sqliteTable(
  "payments",
  {
    ...
    cycleSnapshot: text("cycle_snapshot", { enum: ["weekly", "monthly", "quarterly", "yearly", "custom"] }),
